...
Further, selected analyses are performed by `r paste0(subgroupvars_rs$label, collapse = ", ")`. 
...
The denominator was defined as patients not censored (alive and not emigrated from Sweden) and available in the population, i.e. patients recorded in SwedeHF at the time. 
...
{{< include src/overtime_figs_rs_alt.qmd >}}
